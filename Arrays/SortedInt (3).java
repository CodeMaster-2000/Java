...
public class SortedInt
{
    ...
    */
	...
	int [] userArray;
	String integer = "";
	SortedIntGroup intList;
	c.print("======SORTED INT GROUP TESTING======\n\n");
	c.print("Please enter an INTEGER value as the size of the INTEGER ARRAY: ");
	intList = new SortedIntGroup (c.readInt());
	c.println("The initial INTEGER ARRAY: " + intList.toString());
	c.print("Please enter an SECOND INTEGER value as the size of the INTEGER ARRAY: ");
	intList = new SortedIntGroup (c.readInt());
	c.println("The Second initial INTEGER ARRAY: " + intList.toString());
    }
...
class SortedIntGroup
{
    ...
    */
	...
	for (int i = 0 ; i < this.intArray.length - 1 ; i++)
	{
	    ...
	    //in if loop or not the new creation of array
