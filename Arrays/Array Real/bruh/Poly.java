...
class Polynomial
{
    ...
    // DATA FIELDS
    protected double[] coefficient = new double[0];
    ...
    */
	...
	userInt = Poly.c.readString ();
	for (int i = userInt.length () - 1 ; i >= 0 ; i--)
	{
	    if (userInt.charAt (i) < '0' || userInt.charAt (i) > '9')
	    {
		Poly.c.print ("\nYou have entered an INVALID INTEGER degree value.");
		Poly.c.print ("\nPlease enter a valid INTEGER degree value for your polynomial: ");
		userInt = Poly.c.readString ();
		i = userInt.length ();
	    }
	}
	this.degree = Integer.parseInt (userInt);
	while (this.degree < 0)
	{
	    Poly.c.print ("\nYou have entered an INVALID degree value.");
	    Poly.c.print ("\nPlease re - enter a VALID INTEGER degree value: ");
	...
	{
	    //eurhaourhau
	    Poly.c.print ("Please enter a valid DOUBLE coefficient value for your polynomial of degree " + i + ": ");
