...
class SingleLinkedList implements Cloneable
{
    ...
    */
    ...
    Output:
    */
    public void exchange (String first, String second)
    {
	Node firstNode = this.find (first);
	Node secondNode = this.find (second);
	if (this.root != null && this.root.next != null)
	{
	    Node firstTemp = firstNode;
	    Node secondTemp = secondNode;
	    if (firstNode == null)
		firstNode = this.root;
	    else
		...
		if (firstTemp.next != secondNode || secondNode.next != firstNode)
		{
		    if (firstTemp == null)
		    {
			this.root = secondNode;
			secondNode.next = firstNode.next;
			secondTemp.next = firstNode;
			firstNode.next = temp;
		    }
		    else if (secondTemp == null)
		    {
			firstTemp.next = secondNode;
			secondNode.next = firstNode.next;
			this.root = firstNode;
			firstNode.next = temp;
		    }
