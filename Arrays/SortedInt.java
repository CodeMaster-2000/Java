...
public class SortedInt
{
    ...
    */
	...
	c.print ("Please enter an INTEGER value for the size of the FIRST integer array: ");
	intFirstList = new SortedIntGroup (c.readInt ());
	c.setTextColor(Color.black);
	c.println ("The FIRST integer array: " + intFirstList.toString ());
	c.setTextColor(Color.blue);
	c.print("\nPlease enter an INTEGER value for the size of the SECOND integer array: ");
	...
	c.setTextColor(Color.black);
	c.print("\nPlease enter an INTEGER value for the size of the FIRST integer array: ");
