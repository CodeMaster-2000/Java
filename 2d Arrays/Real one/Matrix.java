    ...
    */
	...
	while (repeat == 0)
	{
		...
		else
		{
		    ...
		    c.print ("Please re - enter VALID method name to act upon given Matrix: ");
		    method = c.readString ();
		}
	    }
	    c.setTextColor (Color.red);
	    ...
	    c.setTextColor (Color.blue);
	    c.print ("\nPlease enter a VALID method name in exact format for given Matrix: ");
	    method = c.readString ();
	    c.clear ();
	    valid = false;
	    while (valid == false)
		...
		if (method.equalsIgnoreCase("clone") == true)
		{
		    ...
		    c.drawString("User Matrix", 0, 85 + 15 * (userMatrix.row + 3));
		    copyMatrix.print(c,15 * (userMatrix.column + 5),85);
		    c.drawString("Copy Matrix",15 * (userMatrix.column + 5), 85 + 15 * (userMatrix.row + 3));
		    copyMatrix.matrix[0][0] = copyValue;
		    userMatrix.print(c,30 * (userMatrix.column + 5),85);
		    c.drawString("User Matrix", 30 * (userMatrix.column + 5), 85 + 15 * (userMatrix.row + 3));
		    copyMatrix.print(c,45 * (userMatrix.column + 5),85);
		    c.drawString("Changed Copy Matrix",45 * (userMatrix.column + 5), 85 + 15 * (userMatrix.row + 3));                    
		    valid = true;
		}
		else if (method.equalsIgnoreCase("columnAverage")== true)
		{
		    ...
		    c.drawString("User Matrix", 0, 45 + 15 * (userMatrix.row + 3));
		    userMatrix.columnAverage().print(c,15 * (userMatrix.column + 5),45);
		    c.drawString("Column Average Matrix",15 * (userMatrix.column + 5),45 + 15 * (userMatrix.row + 3));
		    valid = true;
		}
		else if (method.equalsIgnoreCase("sameSize") == true)
		{
		    ...
		    userMatrix.print(c,0,85);
		    c.drawString("User Matrix", 0, 85 + 15 * (userMatrix.row + 3));
		    secondMatrix.print(c,15 * (userMatrix.column + 5),85);
		    c.drawString("Second Matrix", 15 * (userMatrix.column + 5), 85 + 15 * (userMatrix.row + 3));
		    valid = true;
		}
		...
		else if (method.equalsIgnoreCase("add") == true)
		{
		    ...
		    userMatrix.print(c,0,45);
		    c.drawString("User Matrix", 0, 45 + 15 * (userMatrix.row + 3));
		    secondMatrix.print(c,15 * (userMatrix.column + 5),45);
		    c.drawString("Second Matrix", 15 * (userMatrix.column + 5), 45 + 15 * (userMatrix.row + 3));
		    userMatrix.add(secondMatrix).print(c,30 * (userMatrix.column + 5), 45);
		    c.drawString("Added Matrix", 30 * (userMatrix.column + 5), 45 + 15 * (userMatrix.row + 3));
		    valid = true;
		}
		else if (method.equalsIgnoreCase("sub") == true)
		{
		    ...
		    secondMatrix.print(c,15 * (userMatrix.column + 5),45);
		    c.drawString("Second Matrix", 15 * (userMatrix.column + 5), 45 + 15 * (userMatrix.row + 3));
		    userMatrix.sub(secondMatrix).print(c,30 * (userMatrix.column + 5), 45);
		    c.drawString("Subtracted Matrix", 30 * (userMatrix.column + 5), 45 + 15 * (userMatrix.row + 3));
		    valid = true;
		}
		else if (method.equalsIgnoreCase("minor") == true)
		{
		    ...
		    c.setTextColor(Color.blue);
		    c.print("Please enter a VALID INTEGER row value within the matrix to remove: ");
		    row = c.readInt();
		    c.print("Please enter a VALID INTEGER column value within the matrix to remove: ");
		    column = c.readInt();
		    userMatrix.print(c,0,100);
		    c.drawString("User Matrix", 0, 100 + 15 * (userMatrix.row + 3));
		    userMatrix.minor(row,column).print(c,15 * (userMatrix.column + 5),100);
		    c.drawString("Minor of Matrix", 15 * (userMatrix.column + 5), 100 + 15 * (userMatrix.minor(row,column).row + 3));
		    valid = true;
		}
		else if (method.equalsIgnoreCase("transpose") == true)
		{
		    ...
		    userMatrix.print(c,0,45);
		    c.drawString("User Matrix", 0, 45 + 15 * (userMatrix.row + 3));
		    userMatrix.transpose().print(c,15 * (userMatrix.column + 5),45);
		    c.drawString("Transpose Matrix", 15 * (userMatrix.column + 5), 45 + 15 * (userMatrix.column + 3));
		    valid = true;
		}
		else if (method.equalsIgnoreCase( "determinant") == true)
		{
		    ...
		    userMatrix.print(c,0,45);
		    c.drawString("User Matrix", 0, 45 + 15 * (userMatrix.row + 3));
		    c.drawString("Determinant Value: " + userMatrix.determinant(),0,45 + 15 * (userMatrix.row + 5));
		    valid = true;
		}
		else if (method.equalsIgnoreCase("substitute") == true)
		{
		    ...
		    c.setTextColor(Color.blue);
		    c.print("Please enter a VALID INTEGER column value within the first matrix: ");
		    column = c.readInt();
		    userMatrix.print(c,0,85);
		    c.drawString("User Matrix", 0, 85 + 15 * (userMatrix.row + 3));
		    secondMatrix.print(c,15 * (userMatrix.column + 5),85);
		    c.drawString("Second Matrix", 15 * (userMatrix.column + 5), 85 + 15 * (userMatrix.row + 3));
		    userMatrix.substitute(column, secondMatrix).print(c,15 * (userMatrix.column + 5 + secondMatrix.column + 5), 85);
		    c.drawString("Substitute Matrix",15 * (userMatrix.column + 5 + secondMatrix.column + 5), 85 + 15 * (userMatrix.row + 3));
		    valid = true;
		}
		else if (method.equalsIgnoreCase("split") == true)
		{
		    ...
		    c.print("Matrix Minor Result\n\n");
		    c.setTextColor(Color.blue);
		    c.print("Please enter a VALID INTEGER column value within the matrix to split from: ");
		    column = c.readInt();
		    userMatrix.print(c,0,85);
		    c.drawString("User Matrix", 0, 85 + 15 * (userMatrix.row + 3));
		    userMatrix.split(column).print(c,15 * (userMatrix.column + 5),85);
		    c.drawString("Split Matrix", 15 * (userMatrix.column + 5), 85 + 15 * (userMatrix.row + 3));
		    valid = true;
		}
		else if (method.equalsIgnoreCase("concatenate") == true)
		{
		    ...
		    secondMatrix.print(c,15 * (userMatrix.column + 5),45);
		    c.drawString("Second Matrix", 15 * (userMatrix.column + 5), 45 + 15 * (userMatrix.row + 3));
		    userMatrix.concatenate(secondMatrix).print(c,15 * (userMatrix.column + 5 + secondMatrix.column + 5),45);
		    c.drawString("Combined Matrix",15 * (userMatrix.column + 5 + secondMatrix.column + 5),45 + 15 * (userMatrix.row + 3));
		    valid = true;
		}
		else
		{
	    ...
	    //promp for certain matrix have to fulfill condition
...
class Matrices implements Cloneable
{
    ...
    */
	...
	for (int i = 0 ; i < this.row ; i++)
	{
	    for (int a = 0 ; a < this.column ; a++)
	    {
		c.drawString(this.matrix[i][a] + "",xValue + 30 * a,yValue);
	    }
	    yValue = yValue + 20;
	}
    }
