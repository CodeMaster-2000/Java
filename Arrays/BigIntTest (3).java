...
public class BigIntTest
{
    ...
    */
    ...
    {
	c = new Console ();
	BigPositiveInt integer = new BigPositiveInt (5, 4);
	BigPositiveInt integer2 = new BigPositiveInt (2, 5);
	integer.get();
	integer2.get();
	c.println (integer.toString ());
	c.println(integer2.toString());
	c.println (integer.sub (integer2).toString ());
